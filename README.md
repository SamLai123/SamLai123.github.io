...
1. Cédric Josz, Lexiao Lai, Sufficient conditions for instability of the subgradient method with constant step size, SIAM Journal on Optimization (to appear), 2023 [[preprint](https://arxiv.org/abs/2211.14852)]
